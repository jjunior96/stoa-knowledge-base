...
Todo deck daqui está no **[catálogo do Stoa](https://stoaflow.com.br/catalog)** —
busque, filtre por assunto, veja o preview de um deck e adicione com um clique.

<a href="https://stoaflow.com.br/catalog"><img src="../../.github/assets/explorar-o-catalogo.svg" alt="Explorar o catálogo" height="36" /></a>

[English](../../README.md) · [stoaflow.com.br/catalog](https://stoaflow.com.br/catalog)
...
3 de 12 decks. **[Ver todos os 12 no catálogo do Stoa →](https://stoaflow.com.br/catalog)** · [ou por assunto, abaixo](#o-catálogo)
<!-- featured:end -->
...
Ou pula o link e navega por tudo de uma vez, no próprio Stoa:

```
stoaflow.com.br/catalog                          # todos os decks publicados
stoaflow.com.br/catalog?subject=system-design    # um assunto
```
...
O catálogo mora no Stoa, em
**[stoaflow.com.br/catalog](https://stoaflow.com.br/catalog)**. Não precisa de
conta para navegar:

- **Busque** por título ou descrição, sem diferenciar maiúsculas nem acentos.
- **Filtre por assunto**. O endereço guarda o filtro, então uma visão filtrada
  pode ser compartilhada como link.
- **Veja o preview** de um deck e **adicione à sua conta** sem sair da página.
- Com login, os decks que já estão na sua conta aparecem marcados.

Aqui no GitHub, abra um assunto para ver os decks dele, cada um com um botão que
o adiciona ao Stoa.
...
| [**System Design**](../../subjects/system-design/) | Distributed systems, trade-offs and the vocabulary interviews assume you already have | 7 | [Explorar →](https://stoaflow.com.br/catalog?subject=system-design) |

12 deck(s) em 5 assunto(s). Abra um assunto para ver os decks dele, ou **[explore todos no Stoa →](https://stoaflow.com.br/catalog)**
<!-- catalogue:end -->
...
É esse mesmo manifesto que o [catálogo do Stoa](https://stoaflow.com.br/catalog)
lista: todo deck dele aparece lá, com o assunto, e os decks do
[`featured.json`](#decks-em-destaque) vêm primeiro. A API guarda o manifesto em
cache (cinco minutos por padrão), então uma mudança chega ao catálogo e aos
links poucos minutos depois do merge.
...
featured.json             # opcional: os decks que abrem o README e o catálogo do Stoa
scripts/
...
entra no ar quando ele é mergeado — no link dele e no
[catálogo do Stoa](https://stoaflow.com.br/catalog).
...
**O catálogo do Stoa lê o mesmo arquivo.** Em
[stoaflow.com.br/catalog](https://stoaflow.com.br/catalog), todo deck listado
aqui aparece marcado como destaque e primeiro, nesta ordem, antes dos demais em
ordem alfabética. O README mostra só os três primeiros; o catálogo mostra todos.
Sem o arquivo, o catálogo apenas fica sem destaques.
...
- No merge, o deck está no ar, sem deploy: em poucos minutos o link dele funciona
  e ele aparece no [catálogo do Stoa](https://stoaflow.com.br/catalog).
