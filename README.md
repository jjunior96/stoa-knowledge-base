...
3 of 10 decks. **[Browse the full catalogue →](#the-catalogue)**
<!-- featured:end -->
...
Open a subject to see its decks, each with a button that adds it to Stoa.
...
10 deck(s) across 3 subject(s). Open a subject to see its decks.
<!-- catalogue:end -->
...
featured.json             # optional: the decks shown at the top of this README
scripts/
